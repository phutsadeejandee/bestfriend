<x-app-layout>
    <br>
    <center><h1 class="display-5 fw-bold lh-1 mb-3" style="color: #ff66c4;">คำแนะนำของฉัน</h1></center>
    <br>
    <div class="container">
        <!-- แบบฟอร์ม -->
        <div class="d-flex justify-content-center">
            ...
            <div class="col-md-6">
                <form action="@if (isset($edit->id)) {{ route('advice.update', ['id' => $edit->id]) }}@else{{ route('advice.upload') }} @endif" method="POST"  enctype="multipart/form-data">
